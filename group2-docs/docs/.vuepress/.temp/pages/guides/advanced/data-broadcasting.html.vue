<template><div><h2 id="advanced-guide" tabindex="-1"><a class="header-anchor" href="#advanced-guide"><span>Advanced Guide</span></a></h2>
...
<p>You will learn about three concepts:</p>
<ul>
...
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">import</span> <span class="token punctuation">{</span> omArray<span class="token punctuation">,</span> add <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'openmadness'</span><span class="token punctuation">;</span></span>
...
<span class="line"><span class="token comment">//Output: [90, 95, 100]</span></span>
<span class="line"></span>
...
<span class="line"><span class="token comment">// Expected output: [[11, 22, 33], [14, 25, 36]]</span></span>
<span class="line"></span>
<span class="line"></span></code></pre>
...
<span class="line"><span class="token comment">//Output: [[11, 22], [13, 24]]</span></span>
<span class="line"></span>
<span class="line"></span></code></pre>
