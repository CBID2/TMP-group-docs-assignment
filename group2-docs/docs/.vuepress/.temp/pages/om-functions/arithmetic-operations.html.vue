...
<h2 id="_1-add-a-b" tabindex="-1"><a class="header-anchor" href="#_1-add-a-b"><span>1. <code v-pre>.add(a, b)</code></span></a></h2>
...
<td style="text-align:center">Array</td>
<td style="text-align:center">Resulting array after addition</td>
</tr>
</tbody>
</table>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-subtract-a-b" tabindex="-1"><a class="header-anchor" href="#_2-subtract-a-b"><span>2. <code v-pre>.subtract(a, b)</code></span></a></h2>
...
<td style="text-align:center">Returns</td>
<td style="text-align:center">Array</td>
<td style="text-align:center">Resulting array after subtraction</td>
</tr>
</tbody>
</table>
<p><strong>Example</strong>:</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-multiply-a-b" tabindex="-1"><a class="header-anchor" href="#_3-multiply-a-b"><span>3. <code v-pre>.multiply(a, b)</code></span></a></h2>
...
<td style="text-align:center">Returns</td>
<td style="text-align:center">Array</td>
<td style="text-align:center">Resulting array after multiplication</td>
</tr>
</tbody>
</table>
<p><strong>Example</strong>:</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-divide-a-b" tabindex="-1"><a class="header-anchor" href="#_4-divide-a-b"><span>4. <code v-pre>.divide(a, b)</code></span></a></h2>
...
<td style="text-align:center">Returns</td>
<td style="text-align:center">Array</td>
<td style="text-align:center">Resulting array after division</td>
</tr>
</tbody>
</table>
<p><strong>Example</strong>:</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-pow-a-b" tabindex="-1"><a class="header-anchor" href="#_5-pow-a-b"><span>5. <code v-pre>.pow(a, b)</code></span></a></h2>
...
<td style="text-align:center">Array</td>
<td style="text-align:center">Base values</td>
</tr>
<tr>
<td style="text-align:center">b</td>
<td style="text-align:center">Array or number</td>
<td style="text-align:center">Exponents</td>
</tr>
<tr>
<td style="text-align:center">Returns</td>
<td style="text-align:center">Array</td>
<td style="text-align:center">Array of exponentiated values</td>
</tr>
</tbody>
</table>
<p><strong>Example</strong>:</p>
<div class="language-javascript line-numbers-mode" data-highlighter="prismjs" data-ext="js"><pre v-pre><code><span class="line"><span class="token keyword">import</span> <span class="token punctuation">{</span> pow <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'openmadness'</span><span class="token punctuation">;</span></span>
<span class="line"></span>
<span class="line"><span class="token function">pow</span><span class="token punctuation">(</span><span class="token punctuation">[</span><span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">]</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">)</span><span class="token punctuation">;</span></span>
<span class="line"><span class="token comment">// Result: [4, 9]</span></span>
<span class="line"></span></code></pre>
