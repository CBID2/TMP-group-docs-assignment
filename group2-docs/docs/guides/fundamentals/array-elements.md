...
import { omArray } from 'openmadness';
  const age = omArray [18, 25, 17, 23, 11 ];
  console.log(age [ 4] ); //output 11
  console.log( age [0]) //  output 18
```
...
console.log(age [ 2, 4 ] ); // output 17 and 11
console.log( age [0, 3]) //  output 18 and 23
```
...
import { omArray } from 'openmadness';
const age = onArray [18, 25, 17, 23, 11 ];
console.log(age );  // output 18, 25, 17, 23, 11
```
