...
lang: en-US
title: "Array"
description: "Get to know the basics of array in OpenMadenss library"
---
...
There are different types of arrays in OM, which include:
...
The array [[1, 7], [4, 3]] is a 2-dimensional array made up of two rows: The first row is [1, 7]. The second row is [4, 3].
...
**Explanation**:
The `threeDArray` variable stores a 3-D array with:
